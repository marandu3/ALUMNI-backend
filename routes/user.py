...
from models.user import Usercreate, UserInResponse, Userupdate, UserLogin
...
async def change_password(user_id: int, new_password: str, current_user: dict = Depends(get_current_user)):
